...
const structures = {
	...
	sensors: [ "Sys-SensoTower02", "Sys-CB-Tower01", "Sys-VTOL-CB-Tower01", "Sys-RadarDetector01", "Sys-VTOL-RadarTower01", "Sys-SensoTowerWS", "ECM1PylonMk1", ],
};
...
const bodyStats = [
	...
	{ res: "R-Vehicle-Body13", stat: "Body13SUP", weight: WEIGHT.HEAVY, usage: BODYUSAGE.COMBAT, armor: BODYCLASS.KINETIC }, // wyvern
	{ res: "R-Vehicle-Body14", stat: "Body14SUP", weight: WEIGHT.ULTRAHEAVY, usage: BODYUSAGE.COMBAT, armor: BODYCLASS.KINETIC }, // dragon
	{ res: "R-Vehicle-Body04", stat: "Body4ABT", weight: WEIGHT.LIGHT, usage: BODYUSAGE.UNIVERSAL, armor: BODYCLASS.THERMAL }, // bug
	{ res: "R-Vehicle-Body08", stat: "Body8MBT", weight: WEIGHT.MEDIUM, usage: BODYUSAGE.COMBAT, armor: BODYCLASS.THERMAL }, // scorpion
	{ res: "R-Vehicle-Body12", stat: "Body12SUP", weight: WEIGHT.HEAVY, usage: BODYUSAGE.GROUND, armor: BODYCLASS.THERMAL }, // mantis
	{ res: "R-Vehicle-Body03", stat: "Body3MBT", weight: WEIGHT.LIGHT, usage: BODYUSAGE.UNIVERSAL, armor: BODYCLASS.THERMAL }, // retaliation
	{ res: "R-Vehicle-Body07", stat: "Body7ABT", weight: WEIGHT.MEDIUM, usage: BODYUSAGE.COMBAT, armor: BODYCLASS.THERMAL }, // retribution
...
const weaponStats = {
	...
	cannons_AA: {
		...
		vtols: [],
		defenses: [
			{ res: "R-Defense-AASite-QuadBof", stat: "AASite-QuadBof", defrole: DEFROLE.ANTIAIR },
	...
	rockets_AA: {
		...
		defenses: [
			{ res: "R-Defense-Sunburst", stat: "P0-AASite-Sunburst", defrole: DEFROLE.ANTIAIR }, // sunburst
			{ res: "R-Defense-SamSite1", stat: "P0-AASite-SAM1", defrole: DEFROLE.ANTIAIR }, // avenger
			{ res: "R-Defense-WallTower-SamSite", stat: "WallTower-SamSite", defrole: DEFROLE.GATEWAY }, // avenger
			{ res: "R-Defense-SamSite2", stat: "P0-AASite-SAM2", defrole: DEFROLE.ANTIAIR }, // vindicator
	...
	AA: {
		...
		vtols: [
			{ res: "R-Wpn-Sunburst", stat: "Rocket-VTOL-Sunburst", weight: WEIGHT.LIGHT },
		],
		defenses: [
			{ res: "R-Defense-AASite-QuadMg1", stat: "AASite-QuadMg1", defrole: DEFROLE.ANTIAIR }, // hurricane 
			{ res: "R-Defense-AASite-QuadRotMg", stat: "AASite-QuadRotMg", defrole: DEFROLE.ANTIAIR }, // whirlwind
			{ res: "R-Defense-WallTower-QuadRotAA", stat: "WallTower-QuadRotAAGun", defrole: DEFROLE.GATEWAY },
		],
		templates: [],
		extras: [
	...
	nexusTech: {
		roles: [ 0.4, 0.6, 0.0, 0.0 ],
		chatalias: "nx",
		micro: MICRO.RANGED,
		weapons: [
			//{ res: "R-Wpn-EMPCannon", stat: "EMP-Cannon", weight: WEIGHT.HEAVY },
			//{ res: "R-Wpn-MortarEMP", stat: "MortarEMP", weight: WEIGHT.MEDIUM },
			{ res: "R-Sys-SpyTurret", stat: "SpyTurret01", weight: WEIGHT.MEDIUM },
		],
		vtols: [],
		defenses: [
		    { res: "R-Sys-SpyTurret", stat: "Sys-SpyTower", defrole: DEFROLE.STANDALONE },
		    { res: "R-Wpn-EMPCannon", stat: "WallTower-EMP", defrole: DEFROLE.GATEWAY },
		    { res: "R-Defense-EMPMortar", stat: "Emplacement-MortarEMP", defrole: DEFROLE.STANDALONE }, 
		],
		templates: [],
		extras: [
	...
	lasers_AA: {
		...
		micro: MICRO.RANGED,
		weapons: [
			{ res: "R-Wpn-AALaser", stat: "AAGunLaser", weight: WEIGHT.MEDIUM }, // stormbringer
		],
		vtols: [],
		defenses: [
